package cn.bravedawn.latte.util.clipboard;
...
public class ClipboardUtil {
    ...
    private ClipboardManager.OnPrimaryClipChangedListener onPrimaryClipChangedListener = new ClipboardManager

package cn.bravedawn.fastec.example.push;
...
import cn.bravedawn.fastec.example.ExampleMainActivity;
...
public class PushReceiver extends BroadcastReceiver {
    ...
    private void onOpenNotification(Context context, Bundle bundle) {
        ...
        final Intent intent = new Intent(context, ExampleMainActivity.class);
